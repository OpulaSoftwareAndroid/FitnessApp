...
public class MainUltimateTarget extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(MainUltimateTarget.this, LinearLayoutManager.VERTICAL, false);
