...
public class Dialog_subscribeType extends AppCompatActivity {
    ...
    DialogSubscribeAdapter dialogSubscribeAdapter;
    ...
    Button btnname,btnprice,btntypename;
    AlertDialog alertDialog;



    SharedPreference sharedPreference;
    String TAG="Dialog_subscribeType";
                ...
                public void onResponse(Call<Subscribe> call, retrofit2.Response<Subscribe> response) {
                    ...
                    if (response.body() != null) {
                        ...
                        if (response.body().getStatus() == 1) {
                            ...
                            mainSubscribeAdapter = new MainSubscribeAdapter(Dialog_subscribeType.this,response.body().getInfo());
                            LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(Dialog_subscribeType.this, LinearLayoutManager.VERTICAL, false);
