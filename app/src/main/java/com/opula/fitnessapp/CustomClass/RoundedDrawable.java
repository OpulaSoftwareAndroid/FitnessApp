...
public class RoundedDrawable extends Drawable {
    ...
    private final Paint mBitmapPaint, mSquarePaint;
    ...
    public RoundedDrawable(Bitmap bitmap) {
        ...
        //  mBitmapPaint.setShader(mBitmapShader);
        mSquarePaint.setColor(mBorderColor.getColorForState(getState(), DEFAULT_BORDER_COLOR));
        //  mSquarePaint.setStrokeWidth(mBorderWidth);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (mOval) {
            ...
            if (mBorderWidth > 0) {
                ...
                if (mSquareCorner == null || mSquareCorner.equals("")) {
                    canvas.drawRoundRect(mDrawableRect, mCornerRadius, mCornerRadius, mBitmapPaint);
                } else if (mSquareCorner.equals("left")) {
                    int width = canvas.getWidth();
                    int height = canvas.getHeight();
                    Rect rect = new Rect(0, 0, width, height);
                    RectF rectF = new RectF(rect);
                    canvas.drawRoundRect(rectF, mCornerRadius, mCornerRadius, mBitmapPaint);
                    canvas.drawRect(0, height / 2, width / 2, height, mBitmapPaint);
                } else {
                    int width = canvas.getWidth();
                    int height = canvas.getHeight();
                    Rect rect = new Rect(0, 0, width, height);
                    RectF rectF = new RectF(rect);
                    canvas.drawRoundRect(rectF, mCornerRadius, mCornerRadius, mBitmapPaint);
                    canvas.drawRect(width / 2, height / 2, width, height, mBitmapPaint);
                }
            }
        }
    }
    ...
    public String getSquareCorner() {
        return mSquareCorner;
    }

    public RoundedDrawable setSquareCorner(String corner) {
        mSquareCorner = corner;
        return this;
    }
